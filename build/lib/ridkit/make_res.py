...
from ridkit.lib.utils import replace, make_iter_name, make_walker_name, checkfile, log_task
from ridkit.lib.gen.gen_mdp import make_grompp
from ridkit.lib.gen.gen_plumed import make_res_templ_plumed, conf_res_plumed
from ridkit.lib.gen.gen_shell import gen_res_shell
from ridkit.lib.std import make_std
from ridkit.lib.cal_cv_dim import cal_cv_dim
from ridkit.lib.cluster_cv import sel_from_cluster
...
def make_threshold(walker_idx, walker_path, base_path, sel_angles, cluster_threshold, init_numb_cluster):
    if walker_idx ==0:
...
def make_res (iter_index, 
    ...
    for walker_idx in range(numb_walkers) :
        ...
        if len (graph_files) != 0 :
            ...
            cls_sel = make_threshold(walker_idx, walker_path, base_dir, sel_angles, cluster_threshold, init_numb_cluster)
